...
export default {
  'GET /api/user/authority':(req, res)=>{
    setTimeout(()=>{
      res.send([
        {type:1, path:'/platform'},
        {type:2, path:'/platform/role'},
        {type:2, path:'/platform/user'},
        {type:1, path:'/base'},
  ...
  'POST /api/admin/login': (req, res) => {
    ...
    if (password === '12345221' && userName === 'admin') {
      res.send({
        type,
