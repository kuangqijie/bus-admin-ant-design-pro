    ...
    "routes": [
      ...
      },
      {
        ...
        "routes": [
          ...
          {
            "path": "/bus/order/detail/:id",
            "hideInMenu": true,
            "name": "orderdetail",
            "component": dynamic({ loader: () => import('../Bus/OrderDetail/$id.js'), loading: require('E:/bus-admin/ant-design-pro-master/src/components/PageLoading/index').default  }),
            "exact": true
          },
          {
            "component": dynamic({ loader: () => import('../404'), loading: require('E:/bus-admin/ant-design-pro-master/src/components/PageLoading/index').default  }),
